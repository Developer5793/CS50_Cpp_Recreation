...
void lock_pairs(int& winners, int& losers)
{
    ...
    for (int z = 0; z < p; z++)
    {
        if (strcmp(WinnersandLosersarr[z][4].c_str(), WinnersandLosersarr[k - 1][4].c_str()) == 1)
        {
            WinnersandLosersarr[p][4] = WinnersandLosersarr[k - 1][5];
        }
    }
    p++; 
    ...
    for (int z = 0; z < k; z++)
    {
        if (strcmp(WinnersandLosersarr[z][5].c_str(), WinnersandLosersarr[0][4].c_str())==1)
        {
            WinnersandLosersarr[k][5] = WinnersandLosersarr[0][4];
        }
    }
    k++;
    //---------------------------------------------------------------------------------------------------
