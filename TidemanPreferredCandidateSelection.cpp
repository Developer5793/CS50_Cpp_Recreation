...
void sort_pairs(void)
{
    ...
    //Sort Rankingsarray to compare it with the Winnersandlosersarray next to sort by strongest of one candidate over the other to form a new array
    for (int k = 0; k < 20; k++)
    {
    ...
    for (int g = 0; g < winnerslosersarrlenght; g++)
    {
        ...
        {
            if (WinnersandLosersarr[g][0] == WinnersandLosersarr[g + q][0] && g + q == Rankingsarray[g])
            {
