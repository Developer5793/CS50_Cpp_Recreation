...
void lock_pairs(void)
{
    ...
    for (int c = 0; c < winnerslosersarrlenght; c++)
    {
        if (WinnersandLosersarr[c][1] != WinnersandLosersarr[c + 1][1] || WinnersandLosersarr[c][1] == WinnersandLosersarr[c + 1][1] && WinnersandLosersarr[c][0] != WinnersandLosersarr[c + 1][0])
        {
            for (int d = c + 1; d < winnerslosersarrlenght; d++)
            {
                ...
                {
                    WinnersandLosersarr[d][0] = "";
                    WinnersandLosersarr[d][1] = "";
                    Rankingsarray2[j][1]++;
                }
            }
            j++;
    ...
    //Lock pairs in an Array//Change the if statement
    for (int h = 0; h < winnerslosersarrlenght; h++)
    {
        if (WinnersandLosersarr[h][1] != WinnersandLosersarr[h + 1][1] && WinnersandLosersarr[h][0] == WinnersandLosersarr[h + 1][0] || WinnersandLosersarr[h][0] != WinnersandLosersarr[h + 1][0]&& WinnersandLosersarr[h][1] == WinnersandLosersarr[h + 1][1]|| WinnersandLosersarr[h][0] != WinnersandLosersarr[h + 1][0] && WinnersandLosersarr[h][1] != WinnersandLosersarr[h + 1][1])
        {
            Electionarray[0][p]++;
                p++;
        }
    ...
    for (int q = 0; q < winnerslosersarrlenght; q++)
    {
        cout << Electionarray[0][q];
        cout << " ";
    }
