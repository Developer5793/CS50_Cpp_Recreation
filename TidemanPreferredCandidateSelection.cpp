...
void add_pairs(int ranks[], string namesarr[])
{
    ...
    for (int o = 0; o < 20; o++)
    {
        cout << WinnersandLosersarr[winnerslosersarrlenght1][0];
        cout << "  ";
        cout << WinnersandLosersarr[winnerslosersarrlenght1][1];
        winnerslosersarrlenght1++;
        cout << endl;
    }
    return;
}
